...
<p>Version Control </p>
<div className='main-prasentage'> <div className='prasentage5'style={{width:'65%'}}><span className='prsen'>45%</span></div></div>
...
<h2 className='topic-name'>Soft Skils & Professsional Development</h2>
